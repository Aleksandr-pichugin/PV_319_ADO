	...
	public partial class Form1 : Form
	{
		...
		public void LoadGroupsRelatedData()
		{
			...
			GroupsRelatedData.Relations.Add
				...
				GroupsRelatedData.Tables["Directions"].Columns["direction_id"], //Parent field (Primary key) в другой таблице
				GroupsRelatedData.Tables["Groups"].Columns["direction"]         //Child field  (Foriegn key) в нашей таблице
				);
